"""
1. Для указанной функции f(x)=sqrt(x + 1) − cos(x) по методу наименьших квадратов построить алгебраический полином наилучшего среднеквадратичного приближения третьей 
степени по пяти узлам {x_i} и значениям функции {f(x_i)} в этих узлах.
...
3. Построить графики исходной функции и двух построенных полиномов.
